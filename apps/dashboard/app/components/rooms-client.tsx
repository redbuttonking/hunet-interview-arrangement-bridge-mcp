          ...
          <CardHeader className="gap-5 border-b border-slate-200 p-5 sm:p-6">
            ...
            <div className="flex items-center justify-center gap-2 border-t border-slate-100 pt-4">
              ...
              <div className="relative">
                ...
                {isDatePickerOpen ? <section aria-label="날짜 선택 달력" className="absolute left-1/2 top-full z-30 mt-3 w-[min(22rem,calc(100vw-2rem))] -translate-x-1/2 rounded-2xl border border-slate-200 bg-white p-4 shadow-xl shadow-slate-950/15" role="region">
                  ...
                  <div aria-label={`${formatCalendarMonth(pickerMonth)} 달력`} className="mt-4 grid grid-cols-7 gap-1" role="grid">
                  ...
                  <Button className="mt-4 w-full" onClick={() => selectCalendarDate(todayInSeoul())} variant="secondary">오늘로 이동</Button>
                </section> : null}
              </div>
